...
void main(){gl_Position=position;}`;
  ...
  // Pointer Handler class (tracks movement globally over window)
  class PointerHandler {
    constructor(canvas, scale) {
      ...
      const map = (c, s, x, y) => [x * s, c.height - y * s];
  ...
  const resize = () => {
    ...
    // Set 0.5x resolution of DPR for performance
